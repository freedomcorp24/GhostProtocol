...
import org.ghostprotocol.service.captcha.CaptchaClient;
import org.ghostprotocol.service.storage.ReportedMessageListener;
...
public interface SpamFilter extends Managed {
   ...
   * {@link org.ghostprotocol.service.storage.ReportMessageManager}.
   *
   ...
   * {@link org.ghostprotocol.service.limits.RateLimitChallengeManager}
   *
   ...
   * {@link org.ghostprotocol.service.controllers.MessageController}to determine whether a specific message
   * spend is spam.
   *
