...
import org.ghostprotocol.service.auth.CombinedUnidentifiedSenderAccessKeys;
import org.ghostprotocol.service.auth.GroupSendTokenHeader;
import org.ghostprotocol.service.auth.OptionalAccess;
...
import org.ghostprotocol.service.entities.AccountMismatchedDevices;
import org.ghostprotocol.service.entities.AccountStaleDevices;
import org.ghostprotocol.service.entities.IncomingMessage;
import org.ghostprotocol.service.entities.IncomingMessageList;
import org.ghostprotocol.service.entities.MessageProtos.Envelope;
import org.ghostprotocol.service.entities.MessageProtos.Envelope.Type;
import org.ghostprotocol.service.entities.MismatchedDevices;
import org.ghostprotocol.service.entities.OutgoingMessageEntity;
import org.ghostprotocol.service.entities.OutgoingMessageEntityList;
import org.ghostprotocol.service.entities.SendMessageResponse;
import org.ghostprotocol.service.entities.SendMultiRecipientMessageResponse;
import org.ghostprotocol.service.entities.SpamReport;
import org.ghostprotocol.service.entities.StaleDevices;
...
import org.ghostprotocol.service.limits.CardinalityEstimator;
...
import org.ghostprotocol.service.providers.MultiRecipientMessageProvider;
import org.ghostprotocol.service.push.MessageSender;
...
import org.ghostprotocol.service.spam.SpamChecker;
...
import org.ghostprotocol.service.util.DestinationDeviceValidator;
...
import org.ghostprotocol.websocket.WebsocketHeaders;
...
public class MessageController {
  ...
  public Response sendMessage(@ReadOnly @Auth final Optional<AuthenticatedDevice> source,
    ...
    try {
      ...
      if (spamCheck instanceof SpamChecker.Spam spam) {
        return spam.response();
      } else if (spamCheck instanceof SpamChecker.NotSpam notSpam) {
        reportSpamToken = notSpam.token();
      } else {
        throw new IllegalStateException("Unknown spam check result type");
      }
        ...
        .map(messagesAndHasMore -> {
          ...
          if (!messages.messages().isEmpty()) {
            messageDeliveryLoopMonitor.recordDeliveryAttempt(auth.getAccount().getIdentifier(IdentityType.ACI),
                ...
                messages.messages().stream().findFirst().orElseThrow().guid(),
                userAgent,
                "rest");
          }
