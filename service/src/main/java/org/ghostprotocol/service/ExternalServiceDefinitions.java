...
package org.ghostprotocol.grpc;
...
import org.ghostprotocol.GhostProtocolServerConfiguration;
import org.ghostprotocol.auth.ExternalServiceCredentialsGenerator;
import org.ghostprotocol.configuration.DirectoryV2ClientConfiguration;
import org.ghostprotocol.configuration.PaymentsServiceConfiguration;
import org.ghostprotocol.configuration.SecureValueRecovery2Configuration;
...
enum ExternalServiceDefinitions {
  ...
  private final BiFunction<GhostProtocolServerConfiguration, Clock, ExternalServiceCredentialsGenerator> generatorFactory;

  ExternalServiceDefinitions(
      final ExternalServiceType externalService,
      final BiFunction<GhostProtocolServerConfiguration, Clock, ExternalServiceCredentialsGenerator> factory) {
  ...
  public BiFunction<GhostProtocolServerConfiguration, Clock, ExternalServiceCredentialsGenerator> generatorFactory() {
