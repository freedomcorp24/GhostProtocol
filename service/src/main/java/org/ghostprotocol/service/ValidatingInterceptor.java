...
import static org.ghostprotocol.service.grpc.validators.ValidatorUtils.internalError;
...
import org.ghostprotocol.service.grpc.validators.E164FieldValidator;
import org.ghostprotocol.service.grpc.validators.EnumSpecifiedFieldValidator;
import org.ghostprotocol.service.grpc.validators.ExactlySizeFieldValidator;
import org.ghostprotocol.service.grpc.validators.FieldValidator;
import org.ghostprotocol.service.grpc.validators.NonEmptyFieldValidator;
import org.ghostprotocol.service.grpc.validators.PresentFieldValidator;
import org.ghostprotocol.service.grpc.validators.RangeFieldValidator;
import org.ghostprotocol.service.grpc.validators.SizeFieldValidator;
...
public class ValidatingInterceptor implements ServerInterceptor {
  ...
  private final Map<String, FieldValidator> fieldValidators = Map.of(
      "org.ghostprotocol.chat.require.nonEmpty", new NonEmptyFieldValidator(),
      "org.ghostprotocol.chat.require.present", new PresentFieldValidator(),
      "org.ghostprotocol.chat.require.specified", new EnumSpecifiedFieldValidator(),
      "org.ghostprotocol.chat.require.e164", new E164FieldValidator(),
      "org.ghostprotocol.chat.require.exactlySize", new ExactlySizeFieldValidator(),
      "org.ghostprotocol.chat.require.range", new RangeFieldValidator(),
      "org.ghostprotocol.chat.require.size", new SizeFieldValidator()
  );
