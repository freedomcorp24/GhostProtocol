...
package org.ghostprotocol.metrics;
...
import org.ghostprotocol.GhostProtocolVersion;

@JsonTypeName("ghost-protocol-datadog")
public class GhostProtocolDatadogReporterFactory extends BaseReporterFactory {
  ...
  public ScheduledReporter build(final MetricRegistry registry) {
    ...
    {
      final String versionTag = "version:" + GhostProtocolVersion.getServerVersion();
