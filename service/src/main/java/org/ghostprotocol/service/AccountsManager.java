...
import org.ghostprotocol.auth.SaltedTokenHash;
import org.ghostprotocol.configuration.dynamic.DynamicConfiguration;
import org.ghostprotocol.controllers.MismatchedDevicesException;
import org.ghostprotocol.entities.AccountAttributes;
import org.ghostprotocol.entities.DeviceInfo;
import org.ghostprotocol.entities.ECSignedPreKey;
import org.ghostprotocol.entities.KEMSignedPreKey;
import org.ghostprotocol.entities.RestoreAccountRequest;
import org.ghostprotocol.entities.TransferArchiveResult;
import org.ghostprotocol.identity.IdentityType;
import org.ghostprotocol.identity.ServiceIdentifier;
import org.ghostprotocol.metrics.UserAgentTagUtil;
import org.ghostprotocol.redis.FaultTolerantPubSubConnection;
import org.ghostprotocol.redis.FaultTolerantRedisClient;
import org.ghostprotocol.redis.FaultTolerantRedisClusterClient;
import org.ghostprotocol.securestorage.SecureStorageClient;
import org.ghostprotocol.securevaluerecovery.SecureValueRecovery2Client;
import org.ghostprotocol.securevaluerecovery.SecureValueRecoveryException;
import org.ghostprotocol.util.DestinationDeviceValidator;
import org.ghostprotocol.util.ExceptionUtils;
import org.ghostprotocol.util.Pair;
import org.ghostprotocol.util.SystemMapper;
import org.ghostprotocol.util.Util;
          ...
          if (ExceptionUtils.unwrap(throwable) instanceof ContestedOptimisticLockException && retries > 0) {
            ...
            final boolean tokenReuseConditionFailed =
                transactionCanceledException.cancellationReasons().stream()
                    ...
                    .map(reason -> "ConditionalCheckFailed".equals(reason.code()))
                    .orElse(false);
