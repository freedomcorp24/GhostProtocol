...
public class DynamoDbTables {
  ...
  private final TableWithExpiration groupChats;
  private final TableWithExpiration groupMemberships;
  private final TableWithExpiration vaultItems;
  private final TableWithExpiration shareLinks;
  private final Table cryptoWallets;
  private final TableWithExpiration cryptoTransactions;
  ...
  public DynamoDbTables(
      ...
      @JsonProperty("groupChats") final TableWithExpiration groupChats,
      @JsonProperty("groupMemberships") final TableWithExpiration groupMemberships,
      @JsonProperty("vaultItems") final TableWithExpiration vaultItems,
      @JsonProperty("shareLinks") final TableWithExpiration shareLinks,
      @JsonProperty("cryptoWallets") final Table cryptoWallets,
      @JsonProperty("cryptoTransactions") final TableWithExpiration cryptoTransactions) {
  ...
  @NotNull
  @Valid
  public TableWithExpiration getGroupChats() {
    return groupChats;
  }

  @NotNull
  @Valid
  public TableWithExpiration getGroupMemberships() {
    return groupMemberships;
  }

  @NotNull
  @Valid
  public TableWithExpiration getVaultItems() {
    return vaultItems;
  }

  @NotNull
  @Valid
  public TableWithExpiration getShareLinks() {
    return shareLinks;
  }

  @NotNull
  @Valid
  public Table getCryptoWallets() {
    return cryptoWallets;
  }

  @NotNull
  @Valid
  public TableWithExpiration getCryptoTransactions() {
