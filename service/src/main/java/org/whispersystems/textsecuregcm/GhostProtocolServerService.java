...
import org.ghostprotocol.textsecuregcm.controllers.ProfileController;
...
public class GhostProtocolServerService extends Application<GhostProtocolServerConfiguration> {
  ...
  @Override
  public void initialize(final Bootstrap<GhostProtocolServerConfiguration> bootstrap) {
  ...
  @Override
  public void run(GhostProtocolServerConfiguration config, Environment environment) throws Exception {
