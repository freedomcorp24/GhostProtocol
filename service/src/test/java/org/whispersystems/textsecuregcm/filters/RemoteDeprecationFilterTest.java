...
class RemoteDeprecationFilterTest {
  ...
  void testEmptyMap() throws IOException, ServletException {
    ...
    when(servletRequest.getHeader("UserAgent")).thenReturn("GhostProtocol-Android/4.68.3");
  ...
  private static Stream<Arguments> testFilter() {
    return Stream.of(
        ...
        Arguments.of("GhostProtocol-Android/4.68.3", false),
        Arguments.of("GhostProtocol-iOS/3.9.0", false),
        Arguments.of("GhostProtocol-Desktop/1.2.3", false),
        Arguments.of("GhostProtocol-Android/0.68.3", true),
        Arguments.of("GhostProtocol-iOS/0.9.0", true),
        Arguments.of("GhostProtocol-Desktop/0.2.3", true),
        Arguments.of("GhostProtocol-Desktop/8.0.0-beta.2", true),
        Arguments.of("GhostProtocol-Desktop/8.0.0-beta.1", false),
        Arguments.of("GhostProtocol-iOS/8.0.0-beta.2", false));
  }
