...
public class BackupsDbTest {
  ...
  public void expirationDetectedOnce() {
    ...
    // Expire the media
    final ExpiredBackup mediaBackup = expired.get(0);
    backupsDb.startExpiration(mediaBackup).join();
    backupsDb.finishExpiration(mediaBackup).join();
    ...
    // Expire the messages
    final ExpiredBackup messageBackup = expired.get(0);
    backupsDb.startExpiration(messageBackup).join();
    backupsDb.finishExpiration(messageBackup).join();
