...
class DeviceControllerTest {
  ...
  void getDevices() {
    ...
    assertEquals(deviceId, deviceInfoList.devices().get(0).id());
    assertArrayEquals(deviceName, deviceInfoList.devices().get(0).name());
    assertEquals(deviceCreated, deviceInfoList.devices().get(0).created());
    assertEquals(deviceLastSeen, deviceInfoList.devices().get(0).lastSeen());
  }
