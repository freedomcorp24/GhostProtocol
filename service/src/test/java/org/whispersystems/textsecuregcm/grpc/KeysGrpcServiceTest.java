...
import org.ghostprotocol.chat.keys.GetPreKeyCountRequest;
import org.ghostprotocol.chat.keys.GetPreKeyCountResponse;
import org.ghostprotocol.chat.keys.GetPreKeysRequest;
import org.ghostprotocol.chat.keys.GetPreKeysResponse;
import org.ghostprotocol.chat.keys.KeysGrpc;
import org.ghostprotocol.chat.keys.SetEcSignedPreKeyRequest;
import org.ghostprotocol.chat.keys.SetKemLastResortPreKeyRequest;
import org.ghostprotocol.chat.keys.SetOneTimeEcPreKeysRequest;
import org.ghostprotocol.chat.keys.SetOneTimeKemSignedPreKeysRequest;
...
class KeysGrpcServiceTest extends SimpleBaseGrpcTest<KeysGrpcService, KeysGrpc.KeysBlockingStub> {
  ...
  @ParameterizedTest
  @EnumSource(value = org.ghostprotocol.chat.common.IdentityType.class, names = {"IDENTITY_TYPE_ACI", "IDENTITY_TYPE_PNI"})
  void setOneTimeEcPreKeys(final org.ghostprotocol.chat.common.IdentityType identityType) {
  ...
  private static Stream<Arguments> setOneTimeEcPreKeysWithError() {
    final SetOneTimeEcPreKeysRequest prototypeRequest = SetOneTimeEcPreKeysRequest.newBuilder()
        .setIdentityType(org.ghostprotocol.chat.common.IdentityType.IDENTITY_TYPE_ACI)
  ...
  @ParameterizedTest
  @EnumSource(value = org.ghostprotocol.chat.common.IdentityType.class, names = {"IDENTITY_TYPE_ACI", "IDENTITY_TYPE_PNI"})
  void setOneTimeKemSignedPreKeys(final org.ghostprotocol.chat.common.IdentityType identityType) {
  ...
  @ParameterizedTest
  @EnumSource(value = org.ghostprotocol.chat.common.IdentityType.class, names = {"IDENTITY_TYPE_ACI", "IDENTITY_TYPE_PNI"})
  void setSignedPreKey(final org.ghostprotocol.chat.common.IdentityType identityType) {
  ...
  @ParameterizedTest
  @EnumSource(value = org.ghostprotocol.chat.common.IdentityType.class, names = {"IDENTITY_TYPE_ACI", "IDENTITY_TYPE_PNI"})
  void setLastResortPreKey(final org.ghostprotocol.chat.common.IdentityType identityType) {
  ...
  @ParameterizedTest
  @EnumSource(value = org.ghostprotocol.chat.common.IdentityType.class, names = {"IDENTITY_TYPE_ACI", "IDENTITY_TYPE_PNI"})
  void getPreKeys(final org.ghostprotocol.chat.common.IdentityType grpcIdentityType) {
