...
import org.ghostprotocol.chat.require.Auth;
import org.ghostprotocol.chat.rpc.Color;
import org.ghostprotocol.chat.rpc.ReactorAnonymousServiceGrpc;
import org.ghostprotocol.chat.rpc.ReactorAuthServiceGrpc;
import org.ghostprotocol.chat.rpc.ReactorValidationTestServiceGrpc;
import org.ghostprotocol.chat.rpc.ValidationTestServiceGrpc;
import org.ghostprotocol.chat.rpc.ValidationsRequest;
import org.ghostprotocol.chat.rpc.ValidationsResponse;
...
public class ValidatingInterceptorTest {
  ...
  public void testServiceExtensionValueExtraction() throws Exception {
    ...
    assertEquals(Map.of(
        "org.ghostprotocol.chat.rpc.ValidationTestService", Optional.empty(),
        "org.ghostprotocol.chat.rpc.AuthService", Optional.of(Auth.AUTH_ONLY_AUTHENTICATED),
        "org.ghostprotocol.chat.rpc.AnonymousService", Optional.of(Auth.AUTH_ONLY_ANONYMOUS)
    ), authValues);
  }
