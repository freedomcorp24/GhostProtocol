...
echo "Starting deployment of GhostProtocol components..."

# Create directories on EC2 instance
echo "Creating directories on EC2 instance..."
ssh -i $SSH_KEY_PATH -o StrictHostKeyChecking=no ec2-user@$EC2_PUBLIC_IP "mkdir -p /home/ec2-user/ghostprotocol/admin/css /home/ec2-user/ghostprotocol/admin/js /home/ec2-user/ghostprotocol/api /home/ec2-user/ghostprotocol/web"
...
# Copy web files
scp -i $SSH_KEY_PATH -o StrictHostKeyChecking=no deploy/web/index.html ec2-user@$EC2_PUBLIC_IP:/home/ec2-user/ghostprotocol/web/
